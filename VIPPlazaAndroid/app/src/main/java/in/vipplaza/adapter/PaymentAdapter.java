...
public class PaymentAdapter extends ArrayAdapter<InfoPayments> {

    SharedPreferences mPref;
    private Context activity;
    private ArrayList<InfoPayments> info;
    private LayoutInflater inflater = null;

    DisplayImageOptions options;


    public PaymentAdapter(Context act, int resource,
                           ArrayList<InfoPayments> arrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.name.setText(info.get(position).title );
